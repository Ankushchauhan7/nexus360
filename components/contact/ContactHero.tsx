    ...
    >
      ...
      <div className="relative z-10 max-w-5xl">
        ...
        >
          GET IN
          <br />
          <em className="font-serif not-italic" style={{ color: "var(--gold)" }}>Touch</em>
        </motion.h1>
        ...
        <motion.p
          ...
          style={{ color: "var(--muted)" }}
        >
          Whether you need a free audit, a project quote, or just want to
        ...
        >
          {[
            { label: "Request Free Audit",    anchor: "#audit"   },
            { label: "Get a Project Quote",   anchor: "#quote"   },
            { label: "General Enquiry",       anchor: "#enquiry" },
          ].map((item) => (
            <a
              key={item.label}
              href={item.anchor}
